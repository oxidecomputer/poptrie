...
fn mask_v6(addr: [u8; 16], prefix_len: u8) -> [u8; 16] {
...
fn ipv4_route_strategy() -> impl Strategy<Value = ([u8; 4], u8, u32)> {
...
fn ipv6_route_strategy() -> impl Strategy<Value = ([u8; 16], u8, u128)> {
